...
public class Testing {
    ...
    public void StackLL() {
        ...
        assertEquals(node2, list.pop());
        assertEquals(node1, list.pop());
        assertEquals(node3, list.pop());
        assertEquals(node4, list.pop());
    }
    ...
    public void QueueLL() {
        ...
        SNode node3 = new SNode(5);
        SNode node4 = new SNode(7);
        QueueLL newList = new QueueLL();

        newList.Enqueue(node4);
        newList.Enqueue(node3);
        newList.Enqueue(node6);
        newList.Enqueue(node5);

        newList.Sort();

        assertEquals(1, newList.Dequeue().getData());
        assertEquals(3, newList.Dequeue().getData());
        assertEquals(5, newList.Dequeue().getData());
        assertEquals(7, newList.Dequeue().getData());
    }
}
